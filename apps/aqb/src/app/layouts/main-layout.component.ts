    ...
    <div class="app-layout">
      ...
      <nav class="navigation-rail">
        ...
        <div class="nav-header">
          ...
          >
            <img
              src="logo-light.svg"
              alt="AQB Logo"
              class="app-logo logo-light"
            />
            <img
              src="logo-dark.svg"
              alt="AQB Logo"
              class="app-logo logo-dark"
            />
          </a>
        </div>
        ...
        <div class="nav-bottom">
          ...
          <button
            class="nav-item theme-toggle secondary-action"
        ...
        <mat-sidenav-container class="mobile-container">
          <mat-sidenav #mobileDrawer mode="over" class="mobile-drawer">
            <div class="mobile-nav-header">
              <div class="mobile-app-logo">
                <img
                  src="logo-light.svg"
                  alt="AQB Logo"
                  class="mobile-logo logo-light"
                />
                <img
                  src="logo-dark.svg"
                  alt="AQB Logo"
                  class="mobile-logo logo-dark"
                />
              </div>
              <h2>AQB</h2>
            ...
            <mat-nav-list class="mobile-nav-list">
              ...
              <a
                mat-list-item
                (click)="onLogout(); mobileDrawer.close()"
                (keydown.enter)="onLogout(); mobileDrawer.close()"
                tabindex="0"
              >
              ...
              <a
                mat-list-item
                (click)="themeService.toggleTheme(); mobileDrawer.close()"
                (keydown.enter)="
                  themeService.toggleTheme(); mobileDrawer.close()
                "
                tabindex="0"
              >
              ...
              <a
                mat-list-item
                (click)="openGitHub(); mobileDrawer.close()"
                (keydown.enter)="openGitHub(); mobileDrawer.close()"
                tabindex="0"
              >
