  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        resolve: {
          quizViewModel: (route: ActivatedRouteSnapshot) => from(inject(QuizService).getQuiz(route.params['quizId'])).pipe(
      ...
      },
      {
        ...
        children: [
          {
            path: "questions",
            loadComponent: () => import("./app/features/question-bank/question-bank-edit/question-list-edit/question-bank-details.component").then(m => m.QuestionBankDetailsComponent)
          },
          {
            path: "add",
